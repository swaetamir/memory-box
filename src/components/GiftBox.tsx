...
export default function GiftBox() {
    return (
      <div className="relative w-[734px] h-[523px]">
        ...
        {/* loops for ribbon */}
        <div className="absolute left-[458.45px] top-0 w-[52.07px] h-[142.17px] origin-top-left rotate-[50deg] rounded-full bg-[#D9D9D9]" />
        <div className="absolute left-[242px] top-[39.58px] w-[52.07px] h-[142.17px] origin-top-left rotate-[-50deg] rounded-full bg-[#D9D9D9]" />
      </div>
    );
  }